...
$logoUri = [Uri]"https://github.com/fawnchunk/calamaristuff/blob/main/someone-s-hand-holding-spanner.png?raw=true"
...
$WebsiteBtn.Add_Click({ Start-Process "https://zany-6853.pagelet.host/" })
